...
- **ImageWatcher** - Мониторинг обновлений Docker-образов (аналог pyportainer)
...
## Сравнение с pyportainer

| Возможность | pyportainer | homelab-portainer |
|-------------|-------------|-------------------|
| Async API | Да | Да |
| Image Watcher | Да | Да |
| Event Listener | Да | Да |
| Git Integration | Нет | Да (commit/push/redeploy) |
| Health Monitoring | Нет | Да |
| CLI | Нет | Да |
| Multi-endpoint | Ограничено | Да |
